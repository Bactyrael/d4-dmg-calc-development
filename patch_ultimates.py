...
orderings = {
    "Blood Wave": ["Hematolagnia", "Path of Darkness", "Tides of Blood", "Overpower", "Blood Orb", "Damage Reduction", "Damage Bonus"],
    "Army of the Dead": ["Dead Cold", "Pile the Bodies", "Unyielding Commander", "Corpse Generation", "Passive Bonus", "Damage Bonus", "Cooldown Reduction"],
    "Bone Storm": ["Roll the Bones", "Shadow and Bone", "Hungry Cyclone", "Damage Reduction", "Duration Increase", "Vulnerable", "Barrier"]
}
...
print("Ultimates mapped successfully.")
