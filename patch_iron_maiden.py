...
orderings = {
    "Iron Maiden": ["Blood Maiden", "Torture Artist", "Schadenfreude", "Ferocity and Overpower", "Vulnerable", "Execute and Fortify", "Essence Generation"]
}
...
print("Iron Maiden mapped successfully.")
