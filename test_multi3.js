...
let skill = {name: 'Skeleton Warrior', tags: ['Skill_Primary_Summoning', 'Skill_Primary_Corpse'], dType: 'Physical'}; global.window = {D4_COMPILED_STATS: {'Skill: Corpse Explosion (Bloody Mess) Damage [x]': {final: 50}}}; global.getActiveBuffs = () => ({overpower: 0}); global.getActiveConditions = () => ({vulnerable: true, close: true, corpsesNearby: true, shadowDot: false, cc: false, cursed: false}); console.log(calculateSkillMultiplicativeBucket(skill));