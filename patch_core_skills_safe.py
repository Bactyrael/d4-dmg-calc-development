...
# Since the previous regex approach was complex and prone to errors, I'll just rewrite the Core section manually
# Actually, I can just replace the specific sections directly in the file string since I know the structure.

# We will just replace the modifiers array for each skill.
    ...
    if match:
        ...
        for mod_name in order:
            ...
            if key in mod_dict:
                ...
                # Try finding a partial match (e.g. for Ferocity)
                found = False
