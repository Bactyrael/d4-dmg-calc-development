...
# Corpse Explosion modifiers mapping
orderings = {
    "Corpse Explosion": ["Bloody Mess", "Miasma", "Shrapnel", "Multiple Corpses", "Corpse Efficiency", "Essence Generation", "Blood Orb"]
}
...
print("Corpse Explosion mapped successfully.")
