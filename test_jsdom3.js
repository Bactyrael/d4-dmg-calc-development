...
const dom = new JSDOM(htmlClean, { runScripts: "dangerously" });
...
// Render equipment
window.renderEquipment('Necromancer', {});
...
console.log("Compiled LHC:", stats['Lucky Hit Chance'] ? stats['Lucky Hit Chance'].final : undefined);
console.log("Compiled AtkSpd:", stats['Attack Speed'] ? stats['Attack Speed'].final : undefined);
