...
let formData = fs.readFileSync('assets/paragon_formulas.js', 'utf8');
...
dom.window.eval(`
  ...
  if (window.D4_PARAGON_FORMULAS.attributes[259]) {
      ...
      let parsed = window.cleanAttributeDescription(window.D4_PARAGON_FORMULAS.attributeDescriptions[window.D4_PARAGON_FORMULAS.attributes[259].name], 10, {id: 259, param: 0});
