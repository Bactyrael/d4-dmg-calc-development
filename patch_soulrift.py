...
orderings = {
    "Soulrift": ["Distilled Anime", "Soul Vortex", "Frozen Wasteland", "Damage Bonus", "Barrier", "Vulnerable and Crowd Control", "Ferocity"]
}
    ...
    if match:
        ...
        for mod_name in order:
            ...
            if key in mod_dict:
                ...
                # Try finding a partial match (e.g. for "Distilled Anime" -> "Distilled Anima")
                found = False
        ...
        print(f"Could not find skill {base_skill}")

with open('assets/skills.js', 'w', encoding='utf-8') as f:
    f.write(js_content)

print("Soulrift mapped successfully.")
